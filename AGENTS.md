...
- The llama-skein local provider API is design-first and owned by `/Users/dev/dev/llama-swap/contracts/llama-skein.openapi.json`; read `/Users/dev/dev/llama-swap/docs/openapi-contract.md` before changing llama-skein provider integration.
