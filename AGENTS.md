...
- The llama-skein local provider API is design-first and owned by `~/dev/llama-swap/contracts/llama-skein.openapi.json`; read `~/dev/llama-swap/docs/openapi-contract.md` before changing llama-skein provider integration.
