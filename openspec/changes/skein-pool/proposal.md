...
1. Its slot reservations live in one process. Four opencode processes on one machine each
   see z4 as `in_flight: 0, slots_total: 1` and all four dispatch (2026-07-25).
...
```
● z4        host   qwen3.8-27b   slots 1/1 leased by opencode:A2A feature (0:42 left)
● rocky     host   ornith-35b    slots 0/1 in flight
