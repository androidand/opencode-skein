...
`/Users/dev/dev/brick-now` checkout**, with no separation between them.
...
- `openspec/changes/error-boundaries-plan/.skein/coder-context.md`:
  `Repo root: /Users/dev/dev/opencode-worktrees/error-boundaries-plan`
- `openspec/changes/refactor-context-management-to-intr/.skein/coder-context.md`:
  `Repo root: /Users/dev/dev/opencode-worktrees/refactor-context-management-to-intr`
