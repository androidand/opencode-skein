...
export const Definitions = {
  ...
  model_browse: keybind("none", "Browse and install models from the gallery"),
  model_operations: keybind("none", "Show model downloads and host operations"),
  gallery_dialog_variants: keybind("ctrl+v", "Choose a quantization for the selected host"),
  gallery_dialog_cancel: keybind("ctrl+x", "Cancel the selected host operation"),
  model_manage: keybind("none", "Manage installed models across hosts"),
  gallery_dialog_toggle_loaded: keybind("ctrl+l", "Load or unload the selected model"),
  gallery_dialog_remove: keybind("ctrl+d", "Hide or delete the selected model"),
  gallery_dialog_copy: keybind("ctrl+y", "Copy the selected model to another host"),
  gallery_dialog_move: keybind("ctrl+m", "Move the selected model to another host"),
...
export const CommandMap = {
  ...
  gallery_dialog_variants: "gallery.dialog.variants",
  gallery_dialog_cancel: "gallery.dialog.cancel",
  model_manage: "model.manage",
  gallery_dialog_toggle_loaded: "gallery.dialog.toggle_loaded",
  gallery_dialog_remove: "gallery.dialog.remove",
  gallery_dialog_copy: "gallery.dialog.copy",
  gallery_dialog_move: "gallery.dialog.move",
