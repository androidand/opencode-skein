...
const staleProvider = {
  provider: {
    stale: { npm: "@ai-sdk/openai-compatible", name: "Stale", options: { baseURL: "http://192.0.2.89:11435/v1" } },
  },
}
const freshProvider = {
  provider: {
    fresh: { npm: "@ai-sdk/openai-compatible", name: "Fresh", options: { baseURL: "http://192.0.2.218:11435/v1" } },
  },
}
