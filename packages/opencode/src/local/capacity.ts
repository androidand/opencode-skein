...
//
//   gpuhost2       gpu_util 85%  inference={busy:false, in_flight:0, slots_total:1}
//   gpuhost1    gpu_util 99%  inference={busy:true,  in_flight:1, slots_total:1}
//   gpuhost3  gpu_util  3%  inference={busy:false, in_flight:0, slots_total:1}
//
// gpuhost2 was completely free — 48GB, model resident, nothing queued — while reading
// 85% utilised, because an AMD host pinned at ttl 0 never unloads and idle
// weights read high. gpuhost1's 99% happened to agree with reality, which is what
 ...
 * point of the module, and the gpuhost2 case above is the regression test.
 */
