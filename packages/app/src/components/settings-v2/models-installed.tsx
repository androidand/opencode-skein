...
/**
 * "Installed" — every configured/discovered model, grouped by provider. This
 * is the model-gallery-ui epic's Installed section (design.md decision 7):
 * current discovered models and host/runtime state. The list/filter/toggle
