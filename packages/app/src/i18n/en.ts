...
export const dict = {
  ...
  "settings.models.installed": "Installed",
  "settings.models.discover": "Discover",
  "settings.models.operations": "Operations",
  "settings.models.discover.empty": "No llama-skein hosts discovered yet.",
  "settings.models.discover.hostsTitle": "Discovered hosts",
  "settings.models.discover.hostOnline": "Online",
  "settings.models.discover.hostOffline": "Offline",
  "settings.models.discover.hostInstalledCount.one": "{{count}} model installed",
  "settings.models.discover.hostInstalledCount.other": "{{count}} models installed",
  "settings.models.operations.empty": "No active or recent host operations.",
  "settings.models.discover.search.placeholder": "Search Hugging Face or paste owner/repo",
  "settings.models.discover.search.hint": "Search GGUF models on Hugging Face, or paste an owner/repo to resolve it directly.",
  "settings.models.discover.search.searching": "Searching…",
  "settings.models.discover.search.error": "Search failed",
  "settings.models.discover.search.noResults": "No models found for",
  "settings.models.discover.resultsTitle": "Results",
  "settings.models.discover.seedBadge": "Offline catalog",
  "settings.models.discover.variantCount": "{{count}} variants",
  "settings.models.discover.downloads": "{{count}} downloads",
  "settings.models.discover.details": "Details",
  "settings.models.discover.back": "Back to results",
  "settings.models.discover.repository": "Repository",
  "settings.models.discover.license": "License",
  "settings.models.discover.capabilities": "Capabilities",
  "settings.models.discover.trainedContext": "Trained context",
  "settings.models.discover.parameters": "Parameters",
  "settings.models.discover.pipeline": "Pipeline",
  "settings.models.discover.variants": "Variants",
  "settings.models.discover.variantIncomplete": "incomplete",
  "settings.models.discover.hostsCompare": "Host comparison",
  "settings.models.discover.evaluating": "Asking hosts about fit…",
  "settings.models.discover.evaluateError": "Could not evaluate hosts",
  "settings.models.discover.evaluateEmpty": "No hosts answered for this model.",
  "settings.models.discover.compare.host": "Host",
  "settings.models.discover.compare.status": "Status",
  "settings.models.discover.compare.fit": "Fit",
  "settings.models.discover.compare.context": "Max context",
  "settings.models.discover.compare.vram": "VRAM free / total",
  "settings.models.discover.compare.variant": "Variant",
  "settings.models.discover.compare.unknown": "Unknown",
  "settings.models.discover.compare.installed": "Installed",
  "settings.models.discover.compare.busy": "Busy",
  "settings.models.discover.compare.incompatible": "Not installable",
  "settings.models.discover.install": "Install",
  "settings.models.discover.install.planning": "Preparing plan…",
  "settings.models.discover.install.planError": "Could not prepare install plan",
  "settings.models.discover.install.title": "Confirm install",
  "settings.models.discover.install.description": "llama-skein will download and register this model. Review the plan before continuing.",
  "settings.models.discover.install.host": "Host",
  "settings.models.discover.install.source": "Source",
  "settings.models.discover.install.modelId": "Model ID",
  "settings.models.discover.install.backend": "Backend",
  "settings.models.discover.install.size": "Download size",
  "settings.models.discover.install.files": "{{count}} files",
  "settings.models.discover.install.confirm": "Install",
  "settings.models.discover.install.submitting": "Submitting…",
  "settings.models.discover.install.queued.title": "Install queued",
  "settings.models.discover.install.queued.description": "{{model}} is being installed on {{host}}. Track it under Operations.",
  "settings.models.discover.install.error": "Install failed",
  "settings.models.operations.active": "Active",
  "settings.models.operations.recent": "Recent",
  "settings.models.operations.loadError": "Could not load host operations",
  "settings.models.operations.cancel": "Cancel",
  "settings.models.operations.cancelling": "Cancelling…",
  "settings.models.operations.cancelError": "Could not cancel operation",
  "settings.models.operations.artifacts": "{{count}} files",
  "settings.models.operations.warnings": "Warnings",
  "settings.models.operations.succeeded.title": "Model installed",
  "settings.models.operations.succeeded.description": "{{model}} is now available on {{host}}.",
  "settings.models.operations.phase.queued": "Queued",
  "settings.models.operations.phase.preflighting": "Preflight",
  "settings.models.operations.phase.resolving": "Resolving",
  "settings.models.operations.phase.downloading": "Downloading",
  "settings.models.operations.phase.verifying": "Verifying",
  "settings.models.operations.phase.installing": "Installing",
  "settings.models.operations.phase.registering": "Registering",
  "settings.models.operations.phase.reloading": "Reloading",
  "settings.models.operations.phase.succeeded": "Succeeded",
  "settings.models.operations.phase.cancelled": "Cancelled",
  "settings.models.operations.phase.failed": "Failed",
  "settings.models.hosts.title": "Hosts",
  "settings.models.hosts.loadError": "Could not load host inventory",
  "settings.models.hosts.empty": "No models installed on this host.",
  "settings.models.hosts.sharesStore": "Shares store with {{hosts}}",
  "settings.models.hosts.loaded": "Loaded",
  "settings.models.hosts.default": "Default",
  "settings.models.hosts.busy": "Operation in progress",
  "settings.models.hosts.noSource": "No source repository recorded; cannot copy",
  "settings.models.hosts.load": "Load",
  "settings.models.hosts.unload": "Unload",
  "settings.models.hosts.loading": "Loading…",
  "settings.models.hosts.unloading": "Unloading…",
  "settings.models.hosts.loadError.title": "Could not load model",
  "settings.models.hosts.unloadError.title": "Could not unload model",
  "settings.models.hosts.remove": "Remove",
  "settings.models.hosts.remove.title": "Remove {{model}} from {{host}}",
  "settings.models.hosts.remove.description": "Choose whether to hide the model from this host only or delete its files from the store.",
  "settings.models.hosts.remove.hide": "Hide from this host",
  "settings.models.hosts.remove.hideDescription": "Removes only this host's configuration entry. The files stay in the store and other hosts keep serving the model.",
  "settings.models.hosts.remove.delete": "Delete files",
  "settings.models.hosts.remove.deleteDescription": "Deletes the model's artifact files from the store ({{size}}).",
  "settings.models.hosts.remove.deleteWarning": "This store is shared. Deleting also removes the model from: {{hosts}}.",
  "settings.models.hosts.remove.confirmHide": "Hide",
  "settings.models.hosts.remove.confirmDelete": "Delete",
  "settings.models.hosts.remove.working": "Removing…",
  "settings.models.hosts.remove.error": "Could not remove model",
  "settings.models.hosts.remove.done.hide": "{{model}} hidden from {{host}}",
  "settings.models.hosts.remove.done.delete": "{{model}} deleted ({{count}} files removed)",
  "settings.models.hosts.copy": "Copy to…",
  "settings.models.hosts.move": "Move to…",
  "settings.models.hosts.copy.title": "Copy {{model}}",
  "settings.models.hosts.move.title": "Move {{model}}",
  "settings.models.hosts.copy.description": "Pick a destination host. Hosts sharing the source store only register the model; others download it again from {{source}}.",
  "settings.models.hosts.move.description": "Pick a destination host. Once the destination succeeds, the model is hidden from {{host}} (shared store) or deleted there (separate store).",
  "settings.models.hosts.copy.target": "Destination",
  "settings.models.hosts.copy.registrationOnly": "registration only",
  "settings.models.hosts.copy.download": "downloads again",
  "settings.models.hosts.copy.alreadyInstalled": "already installed",
  "settings.models.hosts.copy.offline": "offline",
  "settings.models.hosts.copy.noTargets": "No other hosts discovered.",
  "settings.models.hosts.copy.confirm": "Copy",
  "settings.models.hosts.move.confirm": "Move",
  "settings.models.hosts.copy.working": "Submitting…",
  "settings.models.hosts.copy.error": "Could not start copy",
  "settings.models.hosts.copy.queued.title": "Copy queued",
  "settings.models.hosts.move.queued.title": "Move queued",
  "settings.models.hosts.copy.queued.description": "{{model}} is being registered on {{host}}. Track it under Operations.",
